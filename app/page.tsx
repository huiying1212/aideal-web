        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-zinc-900 leading-[1.1] tracking-tight animate-fade-in">
              {t("我们是", "We are")}{" "}
              <span className="gradient-text">
                <span className="font-mono">ai{"{"}</span>DEAL
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-delay-2">
            <div className="flex flex-col items-center text-center">
              <img
                src="/team/team_apc_main.jpg"
                alt="Pengcheng An, Ph.D."
                className="w-40 h-40 md:w-48 md:h-48 rounded-full object-cover"
              />

              <div className="mt-6">
                <p className="text-xl md:text-2xl font-medium text-zinc-900 leading-tight">
                  {t("安鹏铖博士", "Pengcheng An, Ph.D.")}
                </p>
                <p className="mt-2 text-base md:text-lg text-zinc-600 leading-tight">
                  {t("助理教授", "Assistant Professor")}
                </p>
                <p className="mt-1 text-base md:text-lg text-zinc-600 leading-tight">
                  {t("创新创意设计学院", "School of Design")}
                </p>
                <p className="mt-1 text-base md:text-lg text-zinc-600 leading-tight">
                  {t(
                    "南方科技大学",
            ...
            {recentPublications.map((item, index) => (
              ...
              >
                ...
                <p className="text-[11px] text-zinc-400 mb-3 font-mono">
                  {"image" in item && item.image && item.image !== "" ? (
                    <img
                      src={item.image}
                      alt={item.title}
                ...
                <h3 className="text-sm font-medium text-zinc-900 leading-snug line-clamp-3">
                  {item.title}
                </h3>
